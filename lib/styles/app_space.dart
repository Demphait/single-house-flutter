...
abstract class AppSpaceBox {
  ...
  ///40
  static SizedBox get xlg => SizedBox(width: AppSpace.xlg, height: AppSpace.xlg);

  ///32
  static SizedBox get lg => SizedBox(width: AppSpace.lg, height: AppSpace.lg);

  ///24
  static SizedBox get def => SizedBox(width: AppSpace.def, height: AppSpace.def);

  ///16
  static SizedBox get md => SizedBox(width: AppSpace.md, height: AppSpace.md);

  ///12
  static SizedBox get smd => SizedBox(width: AppSpace.smd, height: AppSpace.smd);

  ///8
  static SizedBox get sm => SizedBox(width: AppSpace.sm, height: AppSpace.sm);

  ///4
  static SizedBox get xsm => SizedBox(width: AppSpace.xsm, height: AppSpace.xsm);
}