      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const ToggleSetting(name: 'Dark Mode', icon: 'assets/images/dark_mode.svg'),
            const ToggleSetting(name: 'Scroll Folder', icon: 'assets/images/folder.svg'),
            const SettingWidget(name: 'Login', icon: 'assets/images/login.svg', info: 'm.me/Ricardo_M'),
            const SettingWidget(name: 'Email', icon: 'assets/images/email.svg', info: 'example@gmail.com'),
            const SettingWidget(name: 'Language', icon: 'assets/images/language.svg', info: 'English'),
            const Spacer(),
            Padding(
